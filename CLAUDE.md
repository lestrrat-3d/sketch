...
| `sketchtest/` | Public test helpers for solve, verification, profile, and numeric geometry assertions. Every helper consumes the public `sketch` API and fails through `testing.TB`. | — |
