...
each one that is clear of the geometry and of the other names. A name that had to
move is underlined and carries an arrow to the point it names, so a sketch
